export const CWD_CONTRACT = {
    // LOAN_TEMPLATE_PATH: '/home/hieutk/Documents/k5/x-team/make_contract/templates/loan-v2',
    // PATH: '/home/hieutk/Documents/k5/x-team/make_contract/tmp/uploads/${contract_folder}/templates/loan-v2',
    LOAN_TEMPLATE_PATH: '/home/www-data/make_contract/templates/loan-v2',
    PATH: '/home/www-data/make_contract/tmp/uploads/${contract_folder}/templates/loan-v2',
    getPath: (pathConfig, folderContract) => {
        return pathConfig.replace('${contract_folder}', folderContract)
    },
    getPathOut: (folderContract) => {
        return `/home/www-data/make_contract/tmp/uploads/${folderContract}/templates/loan-v2/out/loan-v2.wasm`
    }
}
